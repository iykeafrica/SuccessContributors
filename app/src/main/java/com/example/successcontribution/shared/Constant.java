...
public class Constant {
    ...
    public static final String FIRST_NAME_KEY = "com.example.successcontribution.utils_FIRST_NAME_KEY";
    public static final String LAST_NAME_KEY = "com.example.successcontribution.utils_LAST_NAME_KEY";
    public static final String USER = "ROLE_USER";
    public static final String EXCO = "exco";
    public static final String LOAN_CHECKER = "checker";
    ...
    public static final int SELECT_GUARANTOR_ONE_REQUEST_CODE = 111;
    public static final int SELECT_GUARANTOR_TWO_REQUEST_CODE = 222;

    public static final String SELECT_GUARANTOR_ONE_KEY = "com.example.successcontribution.utils_SELECT_GUARANTOR_ONE_EXTRA";
    public static final String SELECT_GUARANTOR_ONE_STRING_EXTRA = "com.example.successcontribution.utils_SELECT_GUARANTOR_ONE_STRING_EXTRA";
    public static final String SELECT_GUARANTOR_TWO_KEY = "com.example.successcontribution.utils_SELECT_GUARANTOR_TWO_EXTRA";
    public static final String SELECT_GUARANTOR_TWO_STRING_EXTRA = "com.example.successcontribution.utils_SELECT_GUARANTOR_TWO_STRING_EXTRA";

    public static final String SELECT_USER_BY_GUARANTOR_KEY = "com.example.successcontribution.utils_SELECT_USER_BY_GUARANTOR_KEY";
    ...
    public static final String AUTHORIZATION_TOKEN_DEFAULT_KEY = "com.example.successcontribution.utils_AUTHORIZATION_TOKEN_DEFAULT_KEY";
    public static final String USER_ID_DEFAULT_KEY = "com.example.successcontribution.utils_USER_ID_DEFAULT_KEY";

    public static final String HAS_SUBMITTED_SAVED_INSTANCE_STATE = "com.example.successcontribution.utils_HAS_SUBMITTED_SAVED_INSTANCE_STATE";
    public static final String NAME_SAVED_INSTANCE_STATE = "com.example.successcontribution.utils_HAS_SUBMITTED_SAVED_INSTANCE_STATE";
    public static final String GUARANTOR_ONE_SAVED_INSTANCE_STATE = "com.example.successcontribution.utils_HGUARANTOR_ONE_SAVED_INSTANCE_STATE";
    public static final String GUARANTOR_TWO_SAVED_INSTANCE_STATE = "com.example.successcontribution.utils_GUARANTOR_TWO_SAVED_INSTANCE_STATE";
    public static final String STATUS_SAVED_INSTANCE_STATE = "com.example.successcontribution.utils_STATUS_SAVED_INSTANCE_STATE";
    public static final String LOAN_ID_SAVED_INSTANCE_STATE = "com.example.successcontribution.utils_LOAN_ID_SAVED_INSTANCE_STATE";
